    ...
    <div id='wd-quiz-details-editor' className='container mt-4'>
      ...
      <div className='row mb-2'>
        <div className='col'>
          ...
          <input
            id='wd-name'
            value={localDetails.title || "Unnamed Quiz"}
      ...
      <div className='row mb-3'>
        <div className='col-md-12'>
          <label htmlFor='wd-instructions' className='form-label'>
            Quiz Instructions
          </label>
          <textarea
            cols={40}
          ...
          <div className='border p-3'>
            ...
            <div className='form-check d-flex align-items-center'>
              <input
                ...
                defaultChecked
              />
              <label htmlFor='time-limit' className='form-check-label me-3'>
                Time Limit
              </label>
              <input
                type='number'
            ...
            <div className='form-check d-flex align-items-center mt-3'>
              <input
                ...
                className='form-check-input me-2'
                checked={
                  localDetails.settings?.multipleAttempts?.enabled || false
                }
                onChange={(e) => {
              ...
              <input
                ...
                style={{ maxWidth: "80px" }}
                value={
                  localDetails.settings?.multipleAttempts?.attemptsAllowed || 1
                }
                onChange={(e) => {
            ...
            <div className='form-check'>
              <input
                ...
                className='form-check-input'
                checked={
                  localDetails.settings?.lockQuestionsAfterAnswering || false
                }
                onChange={(e) => {
                  const isChecked = e.target.checked;
                  setLocalDetails((prev: any) => ({
              ...
              />
              <label htmlFor='lock-question' className='form-check-label'>
                Lock Question after Answering
              </label>
            </div>
