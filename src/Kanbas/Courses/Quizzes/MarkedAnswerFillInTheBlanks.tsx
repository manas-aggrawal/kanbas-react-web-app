...
export default function MarkedAnswerFillInTheBlanks({
  markedAnswer,
}: {
  markedAnswer: any;
}) {
      ...
      <div>
        ...
        <div className='d-flex align-items-center '>
          ...
          <div className='col-9 p-2'>
            {" "}
            <label className='w-100 ps-1'>{markedAnswer.markedAnswer}</label>
          </div>
        </div>
      </div>
    );
  }
  return markedAnswer.possibleAnswers.map((option: any) => {
    return (
      <div>
        {wrongAnswer}
        <hr />
        <div className='d-flex align-items-center '>
          ...
          <div className='col-9 p-2'>
            {" "}
            <label className='w-100 ps-1'>{option}</label>
          </div>
        </div>
      </div>
    );
