...
function QuestionEditor() {
  ...
  const deleteOption = (index: number) => {
    const newOptions: Option[] = question.options.filter(
      (_: any, i: any) => i !== index
    );
  ...
  return (
    ...
    >
        ...
        <div style={{ display: "flex", flexDirection: "column" }}>
          {question.options.map((option: any, index: any) => (
            <div
              ...
              style={{ padding: "10px" }}
            >
              <h6 style={{ marginRight: "10px" }}>Possible answer:</h6>
              <textarea
                id='myTextarea'
                placeholder='Type your answer here.'
                value={option.option}
      ...
      <div>
        <button onClick={cancel} className='lazy-button-fix mt-2'>
          Cancel
        </button>
