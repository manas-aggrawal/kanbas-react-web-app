    ...
    return (
      <div className='ms-3 mt-2'>
        <div>
          ...
          <button
            className='red-button mt-1'
            onClick={() => goToQuestionEditor(quiz.questions.length)}
          >
            + Question
          </button>
        </div>
        {quiz.questions.map((question: any, index: any) => (
          ...
          >
            ...
            <button
              ...
              onClick={() => goToQuestionEditor(index)}
            >
              Edit
            </button>
            <p>
            ...
            {question.type !== "fill-in-blanks" && (
              <h5>
                <strong>Correct Option: {question.correct_option}</strong>
              </h5>
            )}
          </div>
        ))}
