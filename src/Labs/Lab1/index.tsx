  ...
  return (
    <div id='wd-lab1'>
      ...
      <div id='wd-lists'>
        ...
        My favorite recipe:
        <ol id='wd-banana-shake'>
          <li>Pour milk in blender.</li>
          <li>Put one banana.</li>
          <li>Add some soaked dry fruits.</li>
          <li>Blend!</li>
        </ol>
      ...
      <textarea id='wd-textarea' cols={30} rows={10}>
        Hi! I am Manas Aggrawal and I am taking Web Development CS5610 at
